...
echo "=== gui4aws basic_checks ==="
echo ""
echo "using: ${CLI_PYTHON} -m gui4aws"
echo ""

echo "--- global flags ---"
check "gui4aws --help"    run_cli --help
check "gui4aws --version" run_cli --version

# TODO: add subcommand smoke checks here, e.g.:
# check "gui4aws <subcommand> --help"  run_cli <subcommand> --help
